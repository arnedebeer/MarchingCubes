...
public class VoxelMap : MonoBehaviour {
    ...
    private void Awake() {
        ...
        boxCollider.size = new Vector3(this.size, this.size);
    }
    ...
    private void EditVoxels(Vector3 point) {
        ...
        VoxelBrush activeBrush = new VoxelBrush();
        activeBrush.Initialize(fillTypeIndex == 0);
        ...
        chunks[chunkY * chunkResolution + chunkX].Apply(voxelX, voxelY, activeBrush);
    }
